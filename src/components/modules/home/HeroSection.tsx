...
import { ArrowRight, Star, Sparkles, GraduationCap, Users, CalendarCheck } from "lucide-react";
...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden pt-12 pb-24 lg:pt-20 lg:pb-32">
      ...
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#7c3aed]/5 via-background to-[#ec4899]/5 dark:from-[#7c3aed]/10 dark:via-background dark:to-[#ec4899]/10" />
      
      {/* Animated gradient blobs */}
      <div className="absolute -top-32 -left-32 h-[500px] w-[500px] bg-gradient-to-br from-[#7c3aed] to-[#a855f7] opacity-20 blur-[100px] animate-blob" />
      <div className="absolute top-1/2 -right-32 h-[400px] w-[400px] bg-gradient-to-br from-[#06b6d4] to-[#22d3ee] opacity-15 blur-[100px] animate-blob [animation-delay:2s]" />
      <div className="absolute -bottom-40 left-1/3 h-[450px] w-[450px] bg-gradient-to-br from-[#ec4899] to-[#f472b6] opacity-10 blur-[100px] animate-blob [animation-delay:4s]" />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-6 lg:space-y-8 animate-in fade-in slide-in-from-left-8 duration-700">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center pt-2">
              <Button asChild size="lg" className="btn-3d h-12 lg:h-14 px-6 lg:px-8 text-sm lg:text-base font-bold rounded-xl bg-gradient-to-r from-[#7c3aed] via-[#a855f7] to-[#ec4899] text-white hover:opacity-95 transition-all w-full sm:w-auto">
                <Link href="/tutors">
                  Find Your Tutor <ArrowRight className="ml-2 h-4 w-4 lg:h-5 lg:w-5" />
                </Link>
              </Button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 pt-6 lg:pt-8 border-t border-border/50">
              <Stat icon={<Users className="h-4 w-4 lg:h-5 lg:w-5 text-[#7c3aed]" />} label="Active Tutors" value="500+" />
              <Stat icon={<GraduationCap className="h-4 w-4 lg:h-5 lg:w-5 text-[#ec4899]" />} label="Subject Areas" value="120+" />
              <Stat icon={<Star className="h-4 w-4 lg:h-5 lg:w-5 text-[#f59e0b]" />} label="Avg Rating" value="4.8/5" />
            </div>
          </div>
          ...
          <div className="relative mt-10 lg:mt-0 lg:ml-auto w-full max-w-[500px] xl:max-w-[550px] mx-auto animate-in fade-in zoom-in-95 duration-1000 delay-200">
            <div className="relative animate-float-3d">
              ...
              <div className="absolute -bottom-5 left-4 sm:-bottom-8 sm:-left-8 sm:right-auto rounded-2xl border border-white/10 bg-background/90 p-3 sm:p-5 shadow-2xl backdrop-blur-xl animate-float-3d [animation-delay:1s] z-10 w-fit">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="flex -space-x-2">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="h-6 w-6 sm:h-8 sm:w-8 rounded-full border-2 border-background bg-gradient-to-br from-[#7c3aed] to-[#ec4899] opacity-80" />
                    ))}
                  </div>
                  <div>
              ...
              <div className="absolute -top-6 -right-4 sm:top-12 sm:-left-12 flex items-center justify-center h-12 w-12 sm:h-16 sm:w-16 rounded-2xl bg-white dark:bg-card shadow-xl border border-border/50 animate-float-3d [animation-delay:2.5s] z-10">
                <CalendarCheck className="h-6 w-6 sm:h-8 sm:w-8 text-[#06b6d4]" />
              </div>
            </div>
          </div>
        </div>
